...
Rails.application.configure do
  ...
  # Enable serving images, stylesheets, and JavaScripts from an asset server.
  # config.asset_host = "http://assets.example.com"

  # Store uploaded files on the local file system (see config/storage.yml).
  config.active_storage.service = :local

  # Assume access to app is happening through SSL-terminating reverse proxy.
  ...
  # Replace default in-process and non-durable queuing backend for Active Job.
  ...
  #   /.*\.example\.com/ # allow requests from subdomains
  # ]
  #
