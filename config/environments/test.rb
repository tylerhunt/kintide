Rails.application.configure do
  ...
  # systems to ensure eager loading work properly before deploying your code.
  ...
  # Point links generated in mailer templates at the Capybara server so
  # emailed links can be followed in system specs.
  ...
  # Raise error when a before_action's only/except reference missing actions.
